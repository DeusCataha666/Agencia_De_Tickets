...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Nuevo Tipo de Usuario</h1>
            <p class="text-slate-500 dark:text-slate-400 mt-1 text-sm">Define un nuevo rol o tipo para los usuarios del sistema</p>
        </div>
